...
export class IntersectionPoint extends GeoObject {
    ...
    functionLineIntersection(funcObj, lineObj) {
        ...
        const intersections = Geometry.functionLineIntersection(fn, p1, p2, {
            lineType: lineObj.type,
            domainMin: funcObj.xMin,
            domainMax: funcObj.xMax
        });

        return intersections.filter(point => this.isInRange(lineObj, point));
    }
